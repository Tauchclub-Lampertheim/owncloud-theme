<?php
/**
 * @author Benjamin Ihrig, https://github.com/ihrigb
 * @copyright Copyright (c) 2020, Tauchclub Lampertheim e. V.
 * @license AGPL-3.0
 *
...
class OC_Theme {
	...
	public function getBaseUrl() {
		return 'https://owncloud.tauchclub-lampertheim.de';
	}
	...
	public function getTitle() {
		return 'Tauchclub Lampertheim e. V. - ownCloud';
	}
	...
	public function getEntity() {
		return 'Tauchclub Lampertheim  e. V.';
	}
